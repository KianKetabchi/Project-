...
# URL to your GitHub repository (replace with your actual GitHub repository URL)
github_url = "https://github.com/KianKet/Project-"

# Path to the Excel file inside your GitHub repository
file_path = f"{github_url}/blob/main/48%20Days%20of%20FY24.xlsx?raw=true"

# Load all sheets into a dictionary of DataFrames
all_sheets = pd.read_excel(file_path, sheet_name=None)

# Display data for debugging or verification
for sheet_name, df in all_sheets.items():
    st.write(f"Sheet: {sheet_name}")
    st.write(df)  # Display each DataFrame if needed
